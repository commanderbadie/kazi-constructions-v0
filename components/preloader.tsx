...
export function Preloader() {
  ...
  return (
    ...
    >
      <div className="kazi-preloader-logo flex h-52 w-52 items-center justify-center rounded-[36px] bg-white/95 shadow-2xl shadow-black/40 ring-2 ring-gold/50 kazi-glow-box">
        <img
